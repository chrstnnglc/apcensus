#Compare 2 readings from RPi, just like compare_rpi.py
#But, this will be used specifically for list with persistence (tricycle readings)
import csv
...
with open('trikepersistxgtd.csv','wb') as csvfile:
	...
	write_file.writerow(["Day",str(len(rpi2_list))])
