...
broadband = ["D-LinkIn","Baudtec","FidaInte","Shenzhen","TaicangT","Tp-LinkT","ZyxelCom","Shenzhen","AztechEl","Technico","Netgear","RuckusWi","KasdaNet","Routerbo","D-Link","ZioncomE","Tecnomen","OpenMesh","WesternD","AltaiTec","Cisco","EdimaxTe","TendaTec","AsustekC","Loopcomm","SenaoNet","AskeyCom","BelkinIn","XiaomiEl","ArrisGro","Pegatron","Handlink","Ubiquiti","ReboundT"]
mobile_bb = ["GreenPac"]
hotspot = ["Asiatelc","TctMobil","IeeeRegi"]
phone = ["SamsungE","Apple","VivoMobi","Nokia","SianoMob","RapidMob","Longchee","Microsof","SenaoInt","Guangdon"]
	...
	for line in reader:
		if i != 0:		##ignore first line
			...
			#this will be used for oui lookup
                        ...
                        ap_type = type_check(manuf,ssid,bssid)
...
print "NOT AP: " + str(nap_count)
print "UNIDENTIFIED: " + str(len(unid_manuf))
for item in unid_manuf:
	print item


with open('hs_ssid.csv','wb') as csvfile:
